...
- Extra automatic attributes through LookinServer's `lookin_customDebugInfos` extension point, such as `layer.maskedCorners`.
...
- 通过 LookinServer 的 `lookin_customDebugInfos` 扩展点补充自动采集属性，例如 `layer.maskedCorners`。
