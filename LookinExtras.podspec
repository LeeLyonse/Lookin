Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    ...
    such as `layer.maskedCorners` and common UIKit attributed string properties.
    It also adds the `lkdump__` debug selector bridge for printing property chains
    from the Lookin console.
